  ...
  return (
    <div id='contact'>
        <div className='max-w-96 lg:max-w-2xl mx-auto px-4 mt-12 '>
            ...
            <p className='mt-2 text-neutral-700'>Feel free to reach out to me via email at <span className='underline text-indigo-400'><a href='mailto:abhikmahajan01@gmail.com'>Email</a>
            ...
            <div className='mt-4'>
                <p className='text-gray-600 text-xl'>Want to Chat? Just shoot me a dm on <span className='underline text-blue-600'><a href='https://x.com/abhikmahajan01'>X</a></span>
                . I will respond as soon as possible. I will ignore all soliciting.</p>
            </div>
            <div>
                <ul className='flex gap-6 mt-6 items-center'>
