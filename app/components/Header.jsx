    ...
    <div id='header'>
        <div className='pt-24 max-w-96 lg:max-w-2xl mx-auto px-4 lg:flex gap-10 items-center justify-center'>
            <div className='max-w-lg'>
                <h1 className='text-4xl font-bold'>Hey! I am Abhik</h1>
                <p className='text-xl text-gray-600 mt-3 font-poppins'>Full Stack Developer, Open Source Enthusiast.I love building things! Turning Ideas into Functional, Scalable Products.</p>
            </div>
